...
import { openApplyModal } from '../config'; 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex space-x-8 items-center h-full">
            ...
            {/* <-- NEW CHEF PROTECT LINK --> */}
            <Link to="/protection" className="flex items-center text-orange-600 hover:text-orange-700 font-bold transition-colors">
              <FiShield className="mr-1.5" /> Chef Protect
            </Link>
          </div>
      ...
      {isOpen && (
        <div className="lg:hidden bg-white border-t border-gray-100 shadow-2xl absolute w-full max-h-[85vh] overflow-y-auto">
          <div className="px-4 pt-2 pb-6 space-y-1">
            ...
            {/* <-- NEW CHEF PROTECT MOBILE LINK --> */}
            <Link to="/protection" onClick={closeMenu} className="flex items-center px-3 py-3 text-orange-600 font-bold hover:bg-orange-50 rounded-md">
              <FiShield className="mr-2" /> Chef Protect & Rights
            </Link>
